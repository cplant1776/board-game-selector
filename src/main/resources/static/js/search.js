...
$(document).ready(function() {
    ...
    for (var key in categoryDict) {
        ...
        addedCategoriesRow += '<div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="'+catName+'" value="'+key+'"><label class="form-check-label" for="'+catName+'">'+catName+'</label></div>';
    }
    ...
    for (var key in mechanicDict) {
        ...
        addedMechanicsRow += '<div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="'+mechName+'" value="'+key+'"><label class="form-check-label" for="'+mechName+'">'+mechName+'</label></div>';
    }
